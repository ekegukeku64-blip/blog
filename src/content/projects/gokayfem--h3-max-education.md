---
title: "gokayfem/h3-max-education"
owner: "gokayfem"
name: "h3-max-education"
fullName: "gokayfem/h3-max-education"
description: "Realtime interruptible science tutoring with continuously generated H3 Max video."
sourceUrl: "https://github.com/gokayfem/h3-max-education"
stars: 43
forks: 5
language: "TypeScript"
topics: ["education", "fal-ai", "generative-video", "nextjs", "realtime"]
license: "MIT"
defaultBranch: "main"
snapshotDate: "2026-09-02"
pushedAt: "2026-09-01T13:49:40Z"
---
...
Open http://localhost:3000/learn, allow microphone access, and begin a science conversation.
...
Set the optional standalone gateway's `METRICS_AUTH_TOKEN` to a random value of at least 32 characters when Prometheus scraping is required. `/metrics` returns `404` when the token is unset and requires `Authorization: Bearer ` when enabled.
