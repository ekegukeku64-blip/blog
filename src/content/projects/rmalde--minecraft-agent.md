...
fullName: "rmalde/minecraft-agent"
description: "Astra planner and JEV controller for Minecraft, with native recording, tested routes, and run verification."
sourceUrl: "https://github.com/rmalde/minecraft-agent"
stars: 321
forks: 25
language: "JavaScript"
topics: []
...
- Minecraft demo source: both bounded direct actions and earlier batch actions are documented.
- Mario example: structured observations and a small legal action set.
- StarCraft example: bounded actions, recorded model probabilities, and explicit victory checks.
...
- Mineflayer, Pathfinder, and Prismarine Viewer.
...
The bed timing research also used AltoClef's bed-combat source. The action implementation in this project is separate.
