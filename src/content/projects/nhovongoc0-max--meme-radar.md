---
title: "nhovongoc0-max/meme-radar"
owner: "nhovongoc0-max"
name: "meme-radar"
fullName: "nhovongoc0-max/meme-radar"
description: "Meme雷达开源版：本地只读、多链 Meme 候选扫描与人工复核工具"
sourceUrl: "https://github.com/nhovongoc0-max/meme-radar"
stars: 221
forks: 93
language: "JavaScript"
topics: ["bsc", "crypto", "gmgn", "meme", "security", "solana", "token-scanner"]
license: "AGPL-3.0"
defaultBranch: "main"
snapshotDate: "2026-09-13"
pushedAt: "2026-09-11T12:19:58Z"
---
...
源代码采用 GNU Affero General Public License v3.0（`AGPL-3.0-only`）。可以使用、研究、修改和再发布；若修改后通过网络向他人提供服务，须按许可证向这些用户提供对应源代码。`private: true` 仅用于防止误发 npm。第三方数据接口仍受各自服务条款约束。开源版与专业版边界见 `docs/EDITION-BOUNDARY.md`。
