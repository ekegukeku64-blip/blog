---
title: "v-modal/vmodal_sdk_robotics"
owner: "v-modal"
name: "vmodal_sdk_robotics"
fullName: "v-modal/vmodal_sdk_robotics"
description: "Robotics vision SDK"
sourceUrl: "https://github.com/v-modal/vmodal_sdk_robotics"
stars: 79
forks: 0
language: "Python"
topics: ["multimodal", "multimodal-ai", "multimodal-data", "multimodal-fusion", "multimodal-llm", "physical-ai", "robotics", "robotics-algorithms"]
license: "MIT"
defaultBranch: "main"
snapshotDate: "2026-09-07"
pushedAt: "2026-09-06T13:25:30Z"
---
...
[*图片：Python 3.10–3.13*](https://www.python.org/)
*图片：LeRobot v3*
*图片：Linux*
*图片：MIT*
*图片：runtime deps*
...
Fire. It does not import LeRobot,
...
flowchart LR
    ...
    M --> A[LeRobot adapter]
    D --> A
    A -->|verify + immutable copy| S[(SQLite WALchecksum-keyed objects)]
    S --> V[video lane]
    S --> X[aux laneParquet / metadata / opaque]
    V --> T[Transport]
    X --> T
