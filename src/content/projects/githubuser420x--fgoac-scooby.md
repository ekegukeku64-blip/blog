---
title: "githubuser420x/FGOAC-scooby"
owner: "githubuser420x"
name: "FGOAC-scooby"
fullName: "githubuser420x/FGOAC-scooby"
description: "English launcher and patch for the FGO Arcade local platform"
sourceUrl: "https://github.com/githubuser420x/FGOAC-scooby"
stars: 69
forks: 7
language: "C#"
topics: ["dotnet", "english-patch", "fate-grand-order", "fgo-arcade", "launcher", "wpf"]
license: "MIT"
defaultBranch: "master"
snapshotDate: "2026-09-15"
pushedAt: "2026-09-15T03:32:42Z"
---
...
*图片：Latest release*
*图片：Licence*
[*图片：Discord*](https://discord.gg/aNK3KXBQzw)
...
`docs/GUIDE_EN.pdf` is the full player guide: getting Servants, controls, a
...
`docs/DEVELOPING.md` explains where `src\` comes from, the compile fixes the
decompile needs, what the translation must never change, and how to re-derive the build when the
author ships a new version. `CONTRIBUTING.md` has the house style.
...
`docs/RELEASING.md` has the exact steps and the checks.
...
layer, fgo-arcade-amd-shim, shipped under
