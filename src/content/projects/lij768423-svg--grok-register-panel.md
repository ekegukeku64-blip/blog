...
| `POST /api/start` · `/api/stop` · `/api/control` · `/api/blacklist/reset` | 必须 `Authorization: Bearer ` |
...
MIT — 见 NOTICE 对 AaronL725/grok-register 的归属说明。
