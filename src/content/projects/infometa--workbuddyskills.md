---
title: "infometa/workbuddyskills"
owner: "infometa"
name: "workbuddyskills"
fullName: "infometa/workbuddyskills"
description: "WorkBuddy skills / connectors / experts archive for offline study"
...
每个技能/连接器/专家的**中文用途**、**前置条件**（API Key/登录或「无」）及**可点击链接**，见 **CATALOG.md**。
...
|------|--------|
| 技能 | `~/.workbuddy/skills//` |
| 专家 | `~/.workbuddy/plugins/marketplaces/experts/plugins//` |
| 连接器市场 | `~/.workbuddy/connectors-marketplace/connectors//` |
...
- Experts bundles: `.../workbuddy/expert-marketplace/bundles/.tar.gz`
...
本仓库由自动化脚本每日检查 WorkBuddy 公开市场（skills / connectors / experts / plugins）并同步更新。
