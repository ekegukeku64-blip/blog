...
name: "FlashREINFORCE"
fullName: "yifanzhang-pro/FlashREINFORCE"
description: "FlashREINFORCE:  Critic-Free, Single-Rollout, Asynchronous RL for Agentic Language Models"
sourceUrl: "https://github.com/yifanzhang-pro/FlashREINFORCE"
stars: 40
forks: 3
language: "Python"
topics: []
license: "Apache-2.0"
homepage: "https://yifanzhang-pro.github.io/FlashREINFORCE/"
defaultBranch: "master"
snapshotDate: "2026-09-15"
pushedAt: "2026-09-14T21:56:19Z"
---
...
*图片：Paper*
[*图片：Website*](https://yifanzhang-pro.github.io/FlashREINFORCE/)
*图片：Code*
*图片：License*
...
[Paper] [[Project Website](https://yifanzhang-pro.github.io/FlashREINFORCE/)] [Code]
...
- Reference objective: batch centering, token IS,
  sequence trust, sample mean, and optional entropy-based failure-token filtering.
- Training guide: GPU setup, data preparation, commands,
  paper-to-code mapping, and reproduction limitations.
- Molt launcher: `--dry-run` previews all training flags.
- Experiment settings: task presets, ablations and a native
