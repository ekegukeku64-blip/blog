---
title: "Tyche-MKR/scientific-agent-skills"
owner: "Tyche-MKR"
name: "scientific-agent-skills"
fullName: "Tyche-MKR/scientific-agent-skills"
...
sourceUrl: "https://github.com/Tyche-MKR/scientific-agent-skills"
stars: 60
forks: 20
language: "Python"
topics: []
...
[*图片：Agent Plugins*](https://agent-plugins.org/)
*图片：Security Scan*
*图片：Skill Tests*
*图片：Works with*
[*图片：X*](https://x.com/k_dense_ai)
[*图片：LinkedIn*](https://www.linkedin.com/company/k-dense-inc)
[*图片：YouTube*](https://www.youtube.com/@K-Dense-Inc)
[*图片：Reddit*](https://www.reddit.com/user/-k-dense-/)
...
This repository is a valid [Agent Plugins](https://agent-plugins.org/) 1.0.0 package: root `plugin.json` plus Agent Skills under `skills/`. Clients that support the standard discover every immediate child of `skills/` that contains a `SKILL.md`.
...
Every `SKILL.md` has YAML frontmatter, but legacy and community skills vary in `metadata` formatting (block or flow style) and optional extension fields. Repository updates must keep `metadata.version` as a quoted numeric string and pass canonical `skills-ref validate ./skills/` checks. Hosts may interpret optional metadata and credential prompts differently, so verify behavior on the target host. Because 163 skills add up to a lot of standing context, consider installing a topical subset rather than the whole collection.
