---
title: "joeseesun/qiaomu-book-reader"
owner: "joeseesun"
name: "qiaomu-book-reader"
fullName: "joeseesun/qiaomu-book-reader"
description: "中文优先的 Obsidian 电子书阅读器 | Chinese-first EPUB, FB2 and PDF reader for Obsidian."
sourceUrl: "https://github.com/joeseesun/qiaomu-book-reader"
stars: 76
forks: 7
language: "JavaScript"
topics: ["brat", "chinese", "ebook-reader", "epub", "obsidian", "obsidian-plugin", "pdf", "reading-notes"]
license: "MIT"
homepage: "https://qiaomu.ai"
defaultBranch: "main"
snapshotDate: "2026-09-02"
pushedAt: "2026-09-01T16:29:47Z"
---
...
从 最新版本 下载 `main.js`、`manifest.json` 和 `styles.css`，放入：
...
Qiaomu Book Reader 起源于 MIT 开源项目 swayinfo/elton-reader。感谢 Elton Reader 原作者 Elton Labs 及所有贡献者打下的阅读器基础，为本项目的持续改造提供了代码基础与启发。

当前仓库是由向阳乔木独立维护的长期 fork，已使用独立的插件 ID、发布渠道和产品名称，并持续围绕中文界面、中文阅读排版、阅读笔记与 AI 辅助阅读进行开发。原始版权声明和第三方许可信息保留在 LICENSE 与 NOTICE.md 中。
...
第三方开源软件、上游来源和版权声明见 NOTICE.md 与 LICENSE。
...
Install it with BRAT using `joeseesun/qiaomu-book-reader`, or download `main.js`, `manifest.json`, and `styles.css` from the latest release.
...
Qiaomu Book Reader began as a fork of the MIT-licensed swayinfo/elton-reader project. We thank the original Elton Reader author, Elton Labs, and every contributor whose work provided the technical foundation and inspiration for this project.

This repository is now an independently maintained long-term fork with its own plugin ID, release channel, and product name. Original copyright notices and third-party license information remain in LICENSE and NOTICE.md.

Maintained by [Qiaomu](https://qiaomu.ai). Third-party notices and upstream attribution are preserved in NOTICE.md and LICENSE.
