...
All settings are plain GUCs: `SET jev. = ...`, `ALTER ROLE ... SET`, `ALTER DATABASE ... SET`, or `postgresql.conf`.
...
PostgreSQL License. Jev and TypeSafe are trademarks of their respective owners; this project is not
