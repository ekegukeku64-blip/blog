---
title: "Audio8-AI/Audio8_TTS"
owner: "Audio8-AI"
name: "Audio8_TTS"
fullName: "Audio8-AI/Audio8_TTS"
description: "SOTA-Class TTS at Compact Scale"
sourceUrl: "https://github.com/Audio8-AI/Audio8_TTS"
stars: 205
forks: 21
language: "Python"
topics: []
...
*图片：GitHub*
[*图片：Demo*](https://audio8-ai.github.io/Audio8_TTS/)
[*图片：Hugging Face*](https://huggingface.co/Audio8/Audio8-TTS-Preview-0.6b)
[*图片：ONNX INT4*](https://huggingface.co/Audio8/Audio8-TTS-Preview-0.6B-ONNX-INT4)
*图片：License*
...
`onnx_runtime/` provides a standalone CPU deployment using
...
and follow the ONNX Runtime guide.

## SGLang Omni Serving

The adapter in `sglang_omni/` provides an OpenAI-compatible
...
`sglang_omni/Dockerfile.snippet` after the
...
Apache License 2.0. See NOTICE for attribution details.
