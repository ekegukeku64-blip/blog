...
Snag a time. Get booked.
  A free, self-hostable scheduling app for availability, booking links, calendar sync, email notifications, and test payments.
...
Open AI-assisted setup, copy the student prompt, and paste it into Codex or Claude Code with this repository link:
...
See Integration setup for exact callback URLs, environment variables, and verification steps.
...
The full production architecture is intentionally strict. It uses PostgreSQL 18, forced row-level security, separate app and worker credentials, verified database TLS, and authenticated proxy ingress. Read Deployment guide before choosing a host.
...
Please read Security before exposing a deployment publicly.
...
SnagTime is available under the MIT License.
