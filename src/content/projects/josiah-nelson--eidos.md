...
owner: "josiah-nelson"
name: "eidos"
fullName: "josiah-nelson/eidos"
description: "Windows-first filesystem catalog, content indexer, storage analyzer, and search service (Rust, SQLite, Tantivy, React)"
sourceUrl: "https://github.com/josiah-nelson/eidos"
stars: 164
forks: 0
language: "Rust"
topics: ["filesystem", "indexer", "ntfs", "rust", "search", "storage-analyzer", "tantivy", "windows"]
license: "AGPL-3.0"
defaultBranch: "main"
snapshotDate: "2026-08-24"
pushedAt: "2026-08-24T00:19:23Z"
---
...
> syntax can still change. See docs/roadmap.md.
...
Windows SDK, Node.js 24+. Details in docs/development.md.
...
| Document | Contents |
|---|---|
| docs/overview.md | Goals, product thesis, representative scenarios, functional and reliability requirements |
| docs/architecture.md | Invariants, identity model, catalog and search architecture, scheduler, evolution to a fleet |
| docs/roadmap.md | Releases, milestones, acceptance gates, non-goals |
| docs/query-syntax.md | The query language accepted by the UI, CLI, and API |
| docs/development.md | Toolchain, build/test/lint commands, benchmarks, layout |
| docs/releasing.md | Signed Windows release workflow and Azure Artifact Signing configuration |
| docs/benchmarks.md | Measured results on the reference corpus |
