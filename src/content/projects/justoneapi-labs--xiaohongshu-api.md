---
title: "justoneapi-labs/xiaohongshu-api"
owner: "justoneapi-labs"
name: "xiaohongshu-api"
fullName: "justoneapi-labs/xiaohongshu-api"
description: "小红书API、小红书接口：笔记搜索、笔记详情、评论查询的 Python 调用示例。Just One API。"
sourceUrl: "https://github.com/justoneapi-labs/xiaohongshu-api"
stars: 67
forks: 0
language: "Python"
topics: ["python", "rednote", "rednote-api", "xhs", "xhs-api", "xiaohongshu", "xiaohongshu-api"]
license: "MIT"
homepage: "https://justoneapi.com/zh/?utm_source=github.com&utm_medium=referral&utm_campaign=justoneapi_labs_xiaohongshu_api&utm_content=repo_about_link"
defaultBranch: "main"
snapshotDate: "2026-09-17"
pushedAt: "2026-09-16T15:42:52Z"
---
...
需要异步客户端和更多平台时，可以使用 Just One API Python SDK。本仓库专注于小红书API的最小调用流程。
