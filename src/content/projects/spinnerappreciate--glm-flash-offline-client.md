---
title: "SpinnerAppreciate/glm-flash-offline-client"
owner: "SpinnerAppreciate"
name: "glm-flash-offline-client"
fullName: "SpinnerAppreciate/glm-flash-offline-client"
description: "Offline desktop client for GLM-5.3-Flash — run private, local chat sessions without a server connection."
sourceUrl: "https://github.com/SpinnerAppreciate/glm-flash-offline-client"
stars: 106
forks: 36
language: "HTML"
topics: ["chat-interface", "desktop-app", "desktop-client", "gui", "local-inference", "model-runner", "offline-llm", "windows"]
license: "MIT"
defaultBranch: "main"
snapshotDate: "2026-09-09"
pushedAt: "2026-09-08T16:13:06Z"
---
...
This project is licensed under the MIT License. The included model weights are subject to their own usage terms from the original model provider; review the `THIRD_PARTY_NOTICES` file inside the download archive for details.
