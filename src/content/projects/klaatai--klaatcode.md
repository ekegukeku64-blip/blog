...
sourceUrl: "https://github.com/KlaatAI/klaatcode"
stars: 148
forks: 23
language: "TypeScript"
topics: ["agentic-ai", "ai", "ai-agents", "ai-coding", "ai-model", "ai-tools", "artificial-intelligence", "calude-code"]
license: "NOASSERTION"
homepage: "https://klaatai.com"
defaultBranch: "main"
snapshotDate: "2026-07-20"
pushedAt: "2026-07-19T20:39:24Z"
---
...
Same 33 fixtures, same prompts, same verify command, run against KlaatCode, Claude Code, opencode, Cursor, and Grok Build in one harness. Full methodology and honesty notes: `bench/README.md`. Interactive version with per-task drill-down: [klaatai.com/benchmarks](https://klaatai.com/benchmarks).

[*图片：Cumulative benchmark cost — Klaat Code vs Claude Code, Cursor, and opencode*](https://klaatai.com/benchmarks)
