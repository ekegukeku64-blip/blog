---
title: "jsongmax/oci-core"
owner: "jsongmax"
name: "oci-core"
fullName: "jsongmax/oci-core"
description: "自托管的 Oracle Cloud 多账号管理面板 · 单二进制 · 容量监控与守候 | Self-hosted multi-account control panel for Oracle Cloud"
sourceUrl: "https://github.com/jsongmax/oci-core"
stars: 104
forks: 0
language: "Go"
...
3. ocicore_ocicore-data 卷丢了，所有账号私钥就都解不开了
...
- **自实现签名而非官方 SDK** —— OCI 用的是 draft-cavage HTTP Signatures，约 100 行即可实现。换来极轻的依赖树和完全可控的错误分类。`internal/ociclient/errors.go` 是全项目最重要的一张表：它决定了什么该重试、等多久、什么时候该把账号标成异常。
