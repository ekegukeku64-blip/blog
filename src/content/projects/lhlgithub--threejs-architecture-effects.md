...
fullName: "lhlGitHub/threejs-architecture-effects"
description: "An Agent Skill for building interactive, self-assembling 3D architecture with Three.js.  一个用 Three.js 生成可交互、可动态建造 3D 建筑的 Agent Skill。"
sourceUrl: "https://github.com/lhlGitHub/threejs-architecture-effects"
stars: 127
forks: 28
language: "TypeScript"
topics: []
