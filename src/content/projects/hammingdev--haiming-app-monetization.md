---
title: "HammingDev/haiming-app-monetization"
owner: "HammingDev"
name: "haiming-app-monetization"
fullName: "HammingDev/haiming-app-monetization"
description: "海明Dev： App 商业化 Skill｜onboarding、付费墙、内购选项、竞品调研"
sourceUrl: "https://github.com/HammingDev/haiming-app-monetization"
stars: 101
forks: 11
language: "未知"
topics: []
...
入口为 SKILL.md，行为验收参考 acceptance.md。
...
本仓库采用 MIT 许可证，允许使用、修改、再分发与商业使用；分发时须保留版权声明和许可证。
