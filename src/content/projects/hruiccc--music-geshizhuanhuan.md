---
title: "HRuiCcc/music-geshizhuanhuan"
owner: "HRuiCcc"
name: "music-geshizhuanhuan"
fullName: "HRuiCcc/music-geshizhuanhuan"
description: "全平台加密音乐格式转换器（网页版+命令行）：网易云 NCM / QQ音乐 QMC / 酷狗 KGM / 酷我 KWM 解密与转码，代码从零自研，MIT 协议"
sourceUrl: "https://github.com/HRuiCcc/music-geshizhuanhuan"
stars: 56
forks: 13
language: "Python"
topics: ["audio", "cli", "converter", "decrypt", "flask", "format-conversion", "kgm", "kugou"]
license: "MIT"
defaultBranch: "main"
snapshotDate: "2026-08-26"
pushedAt: "2026-08-25T08:16:35Z"
---
...
```mermaid
flowchart LR
    A[加密文件.ncm / .mflac / .kgm / .kwm ...] --> B[格式识别魔数 + 扩展名]
    B --> C[NCM 解码器RC4-KSA + AES 双层解密钥]
    B --> D[QMC 解码器v1 静态表 / v2 TEA+Map+RC4]
    B --> E[KGM 解码器17 相位组合查表]
    B --> F[KWM 解码器密钥恢复 + 嗅探校验]
    C --> G[容器嗅探flac / mp3 / ogg / m4a / wav]
    D --> G
    E --> G
    F --> G
    G --> H[标签与封面嵌入mutagen]
    H --> I{需要转码?}
    I -- 否 --> J[输出原始容器]
    I -- 是 --> K[ffmpeg 转码mp3 / flac / m4a / wav / ogg]
```
