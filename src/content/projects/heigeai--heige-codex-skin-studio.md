---
title: "HeiGeAi/heige-codex-skin-studio"
owner: "HeiGeAi"
name: "heige-codex-skin-studio"
fullName: "HeiGeAi/heige-codex-skin-studio"
description: "给 Codex Desktop 一键换肤：OpenAI Codex/ChatGPT 桌面端主题工具，CDP 注入零修改应用，Miku/原神/鸣潮/火影/恋与深空 9 预设+自定义图片取色 | One-click theme & skin switcher for OpenAI Codex Desktop (macOS/Windows)"
sourceUrl: "https://github.com/HeiGeAi/heige-codex-skin-studio"
stars: 280
forks: 46
language: "JavaScript"
topics: ["agent-skill", "anime", "chatgpt", "codex", "codex-desktop", "customization", "devtools-protocol", "electron"]
license: "MIT"
homepage: "https://www.heigeai.com/codexskin/"
defaultBranch: "main"
snapshotDate: "2026-07-20"
pushedAt: "2026-07-19T15:59:36Z"
---
...
快速开始 · 做你自己的主题 · 晒图区 · 完整手册 · English · [官网](https://www.heigeai.com/codexskin/)

出品：公众号「黑哥Ai」 · 短视频「黑哥AI实验室」 · 更多开源见 HeiGeAi 组织主页


*图片：真机截图：Miku 主题与顶部主题切换入口*
...
| 鸣潮 | 原神 · 星夜 |
| --- | --- |
| *图片：真机截图：鸣潮主题* | *图片：真机截图：原神星夜主题* |

| 原神 · 破晓 | 大佬 · 点烟 |
| --- | --- |
| *图片：真机截图：原神破晓主题* | *图片：真机截图：大佬点烟彩蛋主题* |
...
现成的生图提示词在主题提示词库：8 套风格，复制就能用。做出好看的主题，来晒图区贴一张，或者用主题晒图模板投稿，被选中会进 README 精选。
...
| 龙珠 · 筋斗云 | 龙珠 · 超级赛亚人 |
| --- | --- |
| *图片：龙珠筋斗云主题主视觉* | *图片：龙珠超级赛亚人主题主视觉* |

| 原神 | 原神 |
| --- | --- |
| *图片：原神 Codex UI 概念一* | *图片：原神 Codex UI 概念二* |

| 鸣潮 | 鸣潮 |
| --- | --- |
| *图片：鸣潮 Codex UI 概念一* | *图片：鸣潮 Codex UI 概念二* |

| 火影忍者 | 火影忍者 |
| --- | --- |
| *图片：火影忍者 Codex UI 概念一* | *图片：火影忍者 Codex UI 概念二* |

| 恋与深空 | 恋与深空 |
| --- | --- |
| *图片：恋与深空 Codex UI 概念一* | *图片：恋与深空 Codex UI 概念二* |
...
- 安全边界：CDP 即使只绑定本机回环也无认证，本机同权限进程在威胁边界内，完整说明见 SECURITY.md；素材来源逐文件登记在 ASSET_PROVENANCE.md。
- 命令行、主题 JSON 格式、常驻细节、全部 FAQ 和设计边界，都在完整手册。
...
**HeiGe Codex Skin Studio** reskins Codex Desktop through loopback CDP injection without modifying `app.asar`, binaries, or signature resources. One image becomes one theme; a top menu switches themes instantly and controls next-launch persistence. Full English documentation: README.en.md.

## 作者与同系项目

由 黑哥AI（HeiGeAi） 打造。公众号「黑哥Ai」写 AI 落地深度文章，短视频账号「黑哥AI实验室」在抖音、B站、视频号、小红书讲人话 AI 科普。同系开源项目见 HeiGeAi 组织主页，内容被 AI 引用优化用的是自家的 HeiGe-GEO-SEO。

## 许可证与素材

代码使用 MIT License。该许可只覆盖软件代码，不授权角色、商标或第三方视觉素材。逐文件来源与授权状态见 ASSET_PROVENANCE.md，发布边界见 NOTICE.md。

**素材风险提示**：免责声明与非商业用途声明不能替代转载、再分发或商标使用许可。来源或授权无法核实的素材在 provenance 表中标为未验证，分发者应自行取得许可或替换。若涉及安全问题，请按 SECURITY.md 私密报告；一般素材权利问题可提交 Issue。

---

**觉得不错就点个 Star。换好了皮肤，来晒图区贴一张。**
