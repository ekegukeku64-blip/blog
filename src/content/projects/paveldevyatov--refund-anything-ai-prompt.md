---
title: "paveldevyatov/refund-anything-ai-prompt"
owner: "paveldevyatov"
name: "refund-anything-ai-prompt"
fullName: "paveldevyatov/refund-anything-ai-prompt"
description: "AI prompt that gets your money back — subscriptions, digital purchases, bookings. Polite letter first, legal escalation second. 30+ jurisdictions."
sourceUrl: "https://github.com/paveldevyatov/refund-anything-ai-prompt"
stars: 53
forks: 3
language: "未知"
topics: ["ai", "chargeback", "chatgpt", "claude", "consumer-rights", "prompt", "refund", "subscription"]
license: "MIT"
defaultBranch: "main"
snapshotDate: "2026-09-09"
pushedAt: "2026-09-08T10:58:14Z"
---
...
A single, self-contained prompt that turns Claude, ChatGPT, or any other capable AI into your personal refund assistant. Paste it, attach your receipt, answer a couple of questions — and get a demand letter that actually gets approved, plus a ready-made escalation plan in case it doesn't.

No lawyer, no templates to fill in, no guessing which law applies. 🙌

👉 **The prompt lives here: `PROMPT.md`**
...
The prompt carries its own compact legal reference for 30+ jurisdictions — EU/EEA, UK, US, Russia, Ukraine, Kazakhstan, Brazil, India, Japan, Turkey, and more — so the model cites the right statute for your country and your reason, and never a mismatched one: a wrong citation invites a rebuttal that discredits the whole letter.
