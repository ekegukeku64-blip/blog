---
title: "openai/PrimeGaps186"
owner: "openai"
name: "PrimeGaps186"
fullName: "openai/PrimeGaps186"
description: "Conditional Lean formalization and numerical certificate for prime gaps at most 186."
sourceUrl: "https://github.com/openai/PrimeGaps186"
stars: 126
forks: 6
language: "Lean"
topics: []
...
The main declarations in PrimeGaps186.lean, in namespace
`PrimeGap186`, are:
...
The Python certificate recomputes the trial
...
proofs in a local Colima Linux VM. The configuration permits
...
Challenge.lean specifies the statements and input assumptions,
with three intentional theorem placeholders. See the
Comparator instructions and
formalization metadata for the checking setup and status.

Project contributions use Apache 2.0; existing third-party notices
remain applicable.
